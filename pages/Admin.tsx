...
const Admin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070b10] text-slate-100 p-4 sm:p-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-white/10 pb-6">
          <div>
            <div className="flex items-center gap-3">
              <span className="px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-300 text-xs font-mono font-bold uppercase tracking-wider border border-emerald-500/40">
                System Admin RBAC
              </span>
              <span className="text-xs text-slate-400 font-mono">v1.1.0</span>
            </div>
            <h1 className="mt-2 text-3xl font-extrabold text-white tracking-tight">AcademiaZen Control Center</h1>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-wrap gap-2 border-b border-white/10 pb-3">
          {[
            ...
            { id: 'announcements', label: '💬 Support & Broadcasts' },
        ...
        <div className="mt-8">
          {loading ? (
            <div className="p-12 text-center text-slate-400 animate-pulse">Loading system statistics...</div>
          ) : (
            <>
              {/* TAB 1: OVERVIEW */}
